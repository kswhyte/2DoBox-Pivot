...
const controller = {
  ...
  renderActiveToDosToDOM: function () {
    ...
    //filter out toDos by importance
      // let importanceBoolString = ''
      // this.filteredImportance.forEach(function(importance) {
      //   let importanceAddition = ''
      //   if (importance.enabled === true) {
      //     importanceAddition = ` || toDo.importance === ${importance.label}`
      //   }
      //   importanceBoolString = `${importanceBoolString}${importanceAddition}`
      // })
      // importanceBoolString = importanceBoolString.substr(4)
      // console.log(importanceBoolString);
